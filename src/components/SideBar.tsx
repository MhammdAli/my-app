...
import { FaBloggerB, FaChevronRight, FaHome, FaMoon, FaPodcast, FaSign, FaSun, FaTags, FaUser, FaUsers } from 'react-icons/fa';
        ...
        <Sidebar open={open}>
          <Header> 
            ...
            <Menu> 
              ...
              <Item title='Create Post' Icon={<FaBloggerB/>} to={'/create/post'}/>
